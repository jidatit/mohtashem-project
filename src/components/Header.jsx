  ...
  return (
    <div className=" z-[999] w-full bg-white px-4 pt-3 pb-2 border-black border-t-[3px] border-x-[3px] border-b-[6px] rounded-[10px] font-secondary flex items-center justify-between">
      ...
      <div className="flex flex-row justify-center items-center gap-1">
        <Link to="https://t.me/SIAMESEMEME" target="_blank" className=" border-black border-t-[2px] border-r-[3px] border-b-[3px] border-l-[2px] hover:border-t-[3px] hover:border-r-[2px] hover:border-b-[2px] hover:border-l-[3px] rounded-[6px] cursor-pointer">
