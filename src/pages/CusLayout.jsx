    ...
    <>
      ...
      <div className=" border-t-2 border-black flex flex-col w-full">
        <div className=" py-3 px-3 bg-blu font-secondary flex flex-col items-center justify-center text-center">
          <p> Legal Disclaimer: $SIAMESE is a meme coin with no intrinsic value or expectation of financial return. The coin is completely useless and for entertainment purposes only.</p>
